...
const articles: Article[] = [
  {
    ...
    title:
      "Tim KKN Universitas Merdeka Malang Kembangkan Hidroponik di Desa Sidorahayu",
    link: "https://kkn34sidorahayuunmer2026.blogspot.com/2026/02/tim-kkn-universitas.html",
  },
];
